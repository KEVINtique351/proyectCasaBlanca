...
function findByParametro(parametro){
    var url = '/getServicio?nombre=' + encodeURIComponent(parametro);
...
function eliminar(id){
    ...
    var url = '/deleteServicio/' + encodeURIComponent(id);
