...
function findByParametro(parametro){
    var url = '/getSalonesByNombre/' + encodeURIComponent(parametro);
...
function eliminar(id){
    ...
    var url = '/deleteSalon/' + encodeURIComponent(id);
