...
<br>
    <main class="contenedor-app">
        ...
        <div class="card card-service">
            <div class="card-header">
                <h5>Configuración de Servicios de Alimentos y bebidas</h5>
            </div>
            <div class="card-body">

                <div class="input-group mb-3">
                    <input type="text" class="form-control" id="txtParametro" placeholder="Buscar Servicio" aria-label="Recipient's username" >
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form >
                ...
                <label for="">Valor Unitario del Servicio</label>
      ...
      <script src="{{ asset('js/servicio.js') }}" />
    <script>
